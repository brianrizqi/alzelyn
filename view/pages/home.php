        ...
        <ul class="nav nav-tabs">
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" >Skincare </a>
                <ul class="dropdown-menu" role="menu">
                    <li role="presentation"><a href="v_produk.php">Skin / Toner</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="v_register.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
                <li><a href="v_login.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
            </ul>
        </ul>
    </div>
</nav>
